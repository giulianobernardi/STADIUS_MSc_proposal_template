...
%
%
%\newcommand{\myName}{Giuliano Bernardi}
%\newcommand{\myNumber}{u$0085510$}
%\newcommand{\myTitle}{Friday meeting}
%\newcommand{\mySubTitle}{2013/03/22}
%\newcommand{\mySupervisors}{Marc Moonen\\Toon van Waterschoot\\Jan Wouters}
%\newcommand{\myLocation}{Kasteelpark Arenberg 10, Heverlee 3001}
%\newcommand{\myMATLABv}{\textsc{matlab}\textsuperscript{\textregistered} 7.12.0 (R2011a)}
%\newcommand{\myGroup}{ESAT}
%\newcommand{\myUrl}{\mail{giuliano.bernardi@esat.kuleuven.be}}
%%\newcommand{\myAA}{2011-2012}
